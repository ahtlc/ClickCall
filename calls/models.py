...
class Contact(models.Model):
  ...
  cellphone = models.CharField(max_length = 20, validators = [cellphone_regex], verbose_name = "Celular")
  phone = models.CharField(max_length = 20, validators = [phone_regex], verbose_name = "Telefone")
