# Generated by Django 2.1.5 on 2019-04-16 00:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('RECEBIDA', 'Recebida'), ('ATENDIDA', 'Atendida'), ('NAO_ATENDIDA', 'Não Atendida'), ('ABANDONADA', 'Abandonada')], default='RC', max_length=12, verbose_name='Status')),
            ],
            options={
